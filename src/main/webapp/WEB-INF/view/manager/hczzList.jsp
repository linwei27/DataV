...
<body>
	<div class="x-nav">
		<span class="layui-breadcrumb"> <a href="javascript:void(0);">首页</a>
			<a href="javascript:void(0);">功能列表</a> <a><cite>合成作战导入</cite></a>
					...
					<div class="layui-card">
						<div class="layui-card-body ">
							<div class="layui-input-inline layui-show-xs-block">
								<input type="text" name="mc" placeholder="请输入名称"
									autocomplete="off" class="layui-input" value="${info.mc}">
							</div>
						...
						<div class="layui-card-header">
							<span class="layui-btn"
								onclick="xadmin.open('导入文件','toUpload?type=1',800,600)" /> <i
...
<script>
	layui.use([ 'laydate', 'form' ], function() {
		var form = layui.form;
		//监听提交
		form.on('submit(hczzList)', function(data) {
			return false;
		});
	});
</script>
