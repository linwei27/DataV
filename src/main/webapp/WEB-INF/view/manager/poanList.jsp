...
<body>
	<div class="x-nav">
		<span class="layui-breadcrumb"> <a href="javascript:void(0);">首页</a>
			<a href="javascript:void(0);">功能列表</a> <a><cite>破案导入</cite></a>
	...
	<div>
		...
		<select id="sell" name="type"
			...
			<option value="1">立案导入</option>

			<!-- 默认显示此值 -->
			<option value="2" selected="selected">破案导入</option>
					...
					<div class="layui-card">
						...
						<div class="layui-card-header">
							<span class="layui-btn"
								onclick="xadmin.open('导入文件','toUpload?type=2',800,600)" /> <i
